...
st.title('Tube wall thickness Calculator')

 

# Use Streamlit widgets to get user input
length_unit = st.selectbox('Choose a length unit:', list(length_units.keys()))
OD = st.number_input(f'Enter the value of OD [{length_unit}]:')
t = st.number_input(f'Enter the value of t [{length_unit}]:')
p_i = st.number_input('Enter the value of p_i:')
pressure_unit_p_i = st.selectbox('Choose a pressure unit for p_i:', list(pressure_units.keys()))
p_e = st.number_input('Enter the value of p_e:')
pressure_unit_p_e = st.selectbox('Choose a pressure unit for p_e:', list(pressure_units.keys()))
