...
#  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
    if cable2 == "Single Core (stranded sheath)":
        ...
        'To do -- choice on the number of core/sheath/armour conductors.'
...
#  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
    if cable2 == "Single Core (tubular sheath)":
        ...
        with col1:
            st.write("")
            radius1 = st.number_input('R1 [mm]', format="%f", value=0.30, step=.1, min_value=.001)
            radius2 = st.number_input('R2 [mm]', format="%f", value=2.35, step=.1, min_value=.001)
            radius3 = st.number_input('R3 [mm]', format="%f", value=2.75, step=.1, min_value=.001)
        with col2:
            st.write("")
            radius5 = st.number_input('R5 [mm]', format="%f", value=4.0, step=.1, min_value=.001)
