...
#  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
    if cable2 == "Single Core (tubular sheath)":
        ...
        with col2:
            ...
            radius5 = st.number_input('R5 [mm]', format="%f", value=4.0, step=.1, min_value=.001)
            radius6 = st.number_input('R6 [mm]', format="%f", value=4.1, step=.1, min_value=.001)
        with col3:
            st.write("")
        ...
        fig.add_shape(type="circle", x0= -radius5-2*ra, y0= -radius5-2*ra, x1= radius5+2ra, y1= outer+2*ra,
                      line_color="LightSeaGreen");
